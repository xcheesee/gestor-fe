...
export default function MaxPrazoInput ({helperText, validade, disabled}) {
    ...
    return(
        <div>
            <div
                className='flex border border-gray-300 border-solid rounded items-center'
            >
                <TextField
                ...
                <TextField
                    ...
                    placeholder={disabled ? "Defina a data de vencimento antes de definir o prazo maximo de prorrogacao" : ""}
                    value={maxPrazo}
                    fullWidth
                    sx={{
                        "& fieldset": { border: 'none' },
